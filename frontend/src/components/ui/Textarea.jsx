export function Textarea({ label, hint, error, className = '', ...props }) {
  return (
    <label className={`block ${className}`}>
      ...
      <textarea
        className={`min-h-28 w-full resize-y rounded-xl border bg-white/90 px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 shadow-sm outline-none transition focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-white ${
